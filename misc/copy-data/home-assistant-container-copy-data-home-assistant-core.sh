...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/michelroegl-brunner/ProxmoxVE/refs/heads/dev/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"
