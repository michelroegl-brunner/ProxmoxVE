...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/michelroegl-brunner/ProxmoxVE/refs/heads/snipeit-bare-metal/misc/copy-data/home-assistant-core-copy-data-home-assistant-core.sh)"
