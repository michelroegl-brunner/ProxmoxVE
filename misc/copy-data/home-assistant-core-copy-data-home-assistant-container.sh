...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/michelroegl-brunner/ProxmoxVE/refs/heads/update_dev/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
