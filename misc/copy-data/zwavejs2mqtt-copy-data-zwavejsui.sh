...
# Use to copy all data from a Zwavejs2MQTT LXC to a Z-wave JS UI LXC
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/michelroegl-brunner/ProxmoxVE/refs/heads/snipeit-bare-metal/misc/copy-data/zwavejs2mqtt-copy-data-zwavejsui.sh)"
