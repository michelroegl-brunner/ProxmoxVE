...
To be able to develop from your own branch you need to change `fs/heads/develop` to `https://raw.githubusercontent.com/[USER]/[REPOSITORY]/refs/head/[BRANCH]`. You need to make this change atleast in misc/build.func misc/install.func and in your ct/AppName.sh. This change is only for testing. Before opening a Pull Request you should change this line change all this baner/ProxmoxVE/refs/heads/develop`.
